    ...
    <a href="" class="infonav"><i class="fa-solid fa-truck-fast" style="color: red;"></i> FRETES</a>
        ...
        <nav>
            ...
            <div class="camp_user">
                ...
                <?php if($id_adm <> null) {
                    ?> <a href="<?php if($row2['adm'] < 1){ ?> php/perfil.php <?php } else{ ?> php/painel_p.php <?php }?>"  style="display: flex;"><img src="<?php echo $row2['img'] ?>" alt="" style="width: 6vh; height: 6vh; margin-right: 8px; border-radius: 50%;">
        ...
        <div class="slideshow-container">
            ...
            <img src="img/INAUGURAÇÃO!!!.png" style="height: 300px;">
            </div>

            <!-- <div class="mySlides fade">
            <img src="img/logo esteves epi.png" style="width: 1000px; height: 300px;">
            </div>

            <div class="mySlides fade">
            <img src="img/logo.png" style="width: 1000px; height: 300px;">
            </div> -->
